...
DIFF = "docs/SPRINT_010_ENTREGA.diff"
ZIP = "sprint_010_entrega.zip"
INVENTORY = "docs/SPRINT_010_ARQUIVOS.txt"
QA = ROOT / "docs/qa-sprint-010"
...
(QA / "git-status.txt").write_bytes(git("status", "--short"))
