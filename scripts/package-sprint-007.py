"""Create portable audit artifacts without changing the Git index/history."""
...
DIFF = "docs/SPRINT_007_ENTREGA.diff"
ZIP = "sprint_007_entrega.zip"
INVENTORY = "docs/SPRINT_007_ARQUIVOS.txt"
QA = ROOT / "docs/qa-sprint-007"
